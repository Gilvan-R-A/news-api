...
router.put('/postagens/:idPostagem', verificarToken, postagemController.alterar.bind(postagemController));
router.delete('/postagens/:idPostagem', verificarToken, postagemController.excluir.bind(postagemController));
